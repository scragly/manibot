"""Launcher with auto-restart ability.
...
def parse_cli_args():
    ...
    parser = argparse.ArgumentParser(
        description="Manibot - Hatigarm Community Discord Bot")
...
def main():
    ...
    while True:
        ...
        code = subprocess.call(["manibot-bot", *bot_args])
